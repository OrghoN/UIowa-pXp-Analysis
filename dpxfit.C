...
//   TH1F *hdpx = new TH1F("histo",
//      "Lorentzian Peak on Quadratic Background",500,-0.5,0.5);
   hdpx->SetMarkerStyle(21);
   hdpx->SetMarkerSize(0.8);
//hdpx->SetStats(0);
   ...
   hdpx->GetYaxis()->SetRangeUser(0,4000);
   hdpx->Fit("fitFcn","V+","ep");
